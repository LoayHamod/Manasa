...
async function getDataById() {
  ...
  if (id) {
    try {
      const res = await fetch(`${baseURL}/lectures/${id}`);
...
async function getDataByTitle() {
  ...
  if (title) {
    try {
      ...
      let url = new URL(`${baseURL}/lectures`);
...
async function deleteAllData() {
  ...
  try {
    const res = await fetch(`${baseURL}/lectures`, { method: "delete" });
...
async function deleteDataById() {
  ...
  try {
    const res = await fetch(`${baseURL}/lectures/${id}`, { method: "delete" });
